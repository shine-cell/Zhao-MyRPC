                           ...
                           muduo::Timestamp)
{
    ...
    google::protobuf::Closure *done = google::protobuf::NewCallback // 不用newCallback也行，可以自己写一个Closure派生类对象，重写Run方法
        <RpcProvider, const muduo::net::TcpConnectionPtr &, google::protobuf::Message *>(this, &RpcProvider::SendRpcResponse, conn, response);
...
// Closure的回调操作，用于序列化rpc的响应和网络发送，相当于就是done里的Run函数
